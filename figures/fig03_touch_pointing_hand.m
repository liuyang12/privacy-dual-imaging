...
params.measthresh = 10; % single channel [ambient light sensor output]
...
% para.rho = 3.8e2; % multiplier (noise regularier) [32x32x100%] (als) [0,18] lux
